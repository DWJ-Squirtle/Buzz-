<template>
	<div class="side-bar-container">
		<div class="title">
			<el-avatar src="https://n.sinaimg.cn/sinakd20114/0/w1152h2048/20200529/3b22-iufmpmn9683169.jpg"></el-avatar>
	...
	data() {
		return {
			imgOptions: [
				{
					id: 1,
					path: "https://cdn.jsdelivr.net/gh/DWJ-Squirtle/blogimage@main/1.jpg",
				},
				{
					id: 2,
					path: "https://cdn.jsdelivr.net/gh/DWJ-Squirtle/blogimage@main/3.jpg",
				},
			],
			value: new Date(),
			value2: null,
			...
			images:{
				icesvg:require("/home/dw/bluebell-plus/bluebell_frontend/src/assets/images/ice.svg")
			}
		};
	},
};
